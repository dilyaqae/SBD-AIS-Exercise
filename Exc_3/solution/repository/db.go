...
func prepopulate(dbConn *gorm.DB) error {
	...
	drinks := []model.Drink{
		{Name: "Cola", Price: 1.5, Description: "Classic drink"},
		{Name: "Iced Latte", Price: 3.5, Description: "Chilled coffee drink"},
		{Name: "Lemonade", Price: 1.0, Description: "Cold and refreshing"},
	}
